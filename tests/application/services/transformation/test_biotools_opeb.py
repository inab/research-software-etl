...
from domain.models.software_instance.main import (
    software_types,
    operating_systems,
    data_sources,
)
    ...
    def test_transform_tool_with_all_fields_filled_correctly(self):
        tool = {
            ...
            "data": {
                ...
                "semantics": {
                    "inputs": [
                        ...
                        },
                        {
                            ...
                            "formats": ["http://edamontology.org/format_3016"],
                        },
                    ],
                    "operations": [
                    ...
                    "outputs": [
                        ...
                        },
                        {
                            ...
                            "formats": ["http://edamontology.org/format_2331"],
                        },
                    ],
                    "topics": [
                ...
                "tags": ["Proteomics"],
                "validated": 1,
                "web": {"homepage": "http://ps2v3.life.nctu.edu.tw/"},
            },
            "@data_source": "biotools",
        ...
        assert instance.description == [
            "Automated homology modeling server. The method uses an effective consensus strategy by combining PSI-BLAST, IMPALA, and T-Coffee in both template selection and target-template alignment. The final three dimensional structure is built using the modeling package MODELLER."
        ]
        assert [
            item.model_dump() for item in instance.publication
        ] == []  # publications are processed separately
        ...
        assert [item.model_dump() for item in instance.documentation] == [
            {
                "type": "general",
                "url": AnyUrl("http://ps2v3.life.nctu.edu.tw/help.php"),
                "content": None,
            }
        ]
        ...
        assert [item.model_dump() for item in instance.output] == [
            ...
            },
            {
                ...
                "datatype": {"vocabulary": "", "term": "", "uri": None},
            },
            {
                "vocabulary": "EDAM",
                "term": "HTML",
    ...
    def test_transform_tool_with_empty_fields_filled_correctly(self):
        tool = {
            ...
            "data": {
                ...
                "credits": [],
                "description": "",
                "documentation": {"doc_links": [], "general": ""},
                "languages": [],
                "name": "",
                "os": [],
                "publications": [],
