    ...
    def test_transform_single_tool(self, mocker):
        ...
        tool = {
            ...
            "data": {
                ...
                "test": {
                    "commands": ["$R -e \"library('MafDb.gnomADex.r2.1.hs37d5')\""]
                },
                "@type": "lib",
            },
        }
        ...
        assert instance.webpage == [
            HttpUrl(
                "https://bioconductor.org/packages/3.16/data/annotation/html/MafDb.gnomADex.r2.1.hs37d5.html"
            )
        ]
        ...
        assert [item.model_dump() for item in instance.documentation] == [
            {
                "url": AnyUrl(
                    "https://bioconda.github.io/recipes/bioconductor-mafdb.gnomadex.r2.1.hs37d5/README.html"
                ),
