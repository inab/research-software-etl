...
original_dis_one = {
    ...
    "repository": [],
    "webpage": ["github.com/wrenlab/label-extraction"],
...
original_remaining_one = {
    ...
    "repository": ["github.com/sc932/ALE"],
    "webpage": ["github.com/sc932/ALE"],
...
original_conflict_one_two = {
    "disconnected": [copy.deepcopy(original_dis_one)],
    "remaining": [
...
original_conflict_two_one = {
    ...
    "remaining": [copy.deepcopy(original_remaining_two)],
}
...
expected_one_two = {
    "merged_entries": [
        ...
        "bioconda_recipes/ale-core/cmd/20220503",
    ],
...
expected_heuristics = {
    ...
    "mapcaller/cmd": {
        "merged_entries": [
            "bioconda_recipes/mapcaller/cmd/0.9.9.41",
