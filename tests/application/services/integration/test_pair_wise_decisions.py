from tests.application.services.integration.data.data_disambiguation_build_pairs import (
...
def test_basic_cache_hit():
    ...
    test_pair_id = (
        "p:antarna/cmd_3c869e64bce3da9b19c8669124eed04be0aedcf2e6a816c4fe144fd6876e21a9"
    )
...
def test_override_human():
    ...
    pair_id = (
        "p:antarna/cmd_a9cc22f1a14ff7b28a01fbd6ffbca27d54a8f1370b5091f72ae43a591cdd5e08"
    )
    PAIRS_PATH = "/Users/evabsc/projects/software-observatory/research-software-etl/tests/application/services/integration/data/test_pair_decisions.jsonl"
...
def test_latest_preferred():
    pair_id = (
        "p:antarna/cmd_8fab3505670c69befd6d97f3f8ab64606f113b78eec3ab45aeead8fbee9df71d"
    )
    PAIRS_PATH = "/Users/evabsc/projects/software-observatory/research-software-etl/tests/application/services/integration/data/test_pair_decisions.jsonl"
    best_pair = load_pair_decisions(PAIRS_PATH)
