...
def log_types(data):
    ...
    with open('scripts/data/types.txt', 'w') as f:
...
def log_names(data):
    ...
    with open('scripts/data/names.txt', 'w') as f:
        for key, value in data.items():
            unique_names = set()
            for inst in value["instances"]:
...
if __name__ == "__main__":
    input_file = "scripts/data/grouped_entries.json"
    ...
    '''
    with open('scripts/data/shared_links.json', 'r') as f:
