...
class Metadata(BaseModel):
    ...
    created_by: Optional[str] = Field(
        None, description="Reference to the entity that created this entry"
    )
    created_logs: Optional[str] = Field(
        None, description="Logs or pipelines related to the creation"
    )
    ...
    updated_by: Optional[str] = Field(
        None, description="Reference to the entity that last updated this entry"
    )
    updated_logs: Optional[str] = Field(
        None, description="Logs or pipelines related to the last update"
    )
