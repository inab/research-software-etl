...
def main():
    ...
    parser.add_argument(
        ...
        "-g",
        help=(
            "Path to the file containing grouped entries. Generated by the grouping and recovery step of the integration. Default is 'data/grouped.json'."
        ),
        type=str,
    ...
    parser.add_argument(
        ...
        "-d",
        help=(
            "Path to the file containing disconnected entries. This is the output of the process. Default is 'data/disconnected.json'."
        ),
        type=str,
