...
async def main():
    ...
    parser.add_argument(
        ...
        help=("Path to the file containing disconnected entries. Default is 'data/disconnected.json'."),
        type=str,
    ...
    from src.application.use_cases.integration.benchmarking.message_preparation import prepare_messages

    await prepare_messages(args.disconnected_entries_file, args.grouped_entries_file, args.evaluation_cases_csv, args.messages_file, args.prompt_type)
