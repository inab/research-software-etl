...
from application.services.integration.disambiguation.pair_decisions_update import (
    update_pair_decisions,
)
...
def run_disambiguation_after_human_annotation(
    ...
    pair_decisions_path="src/application/services/integration/disambiguation/pair_decisions.jsonl",
):
    print("Starting update of pair decisions from human annotations...")

    total_human, already_present, appended = update_pair_decisions(
        human_logs_path=human_log_path,
        pair_decisions_path=pair_decisions_path,
    )

    print("Pair decisions update completed.")
