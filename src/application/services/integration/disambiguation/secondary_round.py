...
async def run_second_round(
    blocks, config, run_id, disambiguate_blocks_func, clients, repos, dry_run
):
    """
    ...
    secondary_conflict, secondary_block = generate_secondary_conflicts(
    ...
    print(
        f"🔁 {len(secondary_conflict)} secondary conflict blocks generated and added."
    )
