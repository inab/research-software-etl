        ...
        if tool.get("about"):
            if tool["about"].get("docs"):
                ...
                if biocondaRecipesStandardizer.is_valid_url(tool["about"]["docs"]):
                    documentation.append(
                        {"type": "general", "url": tool["about"]["docs"]}
                    )
                ...
                if biocondaRecipesStandardizer.is_valid_url(tool["about"]["doc_url"]):
                    documentation.append(
                        {"type": "general", "url": tool["about"]["home"]}
                    )
        ...
        if tool.get("about"):
            if tool["about"].get("maintainers"):
                ...
                if isinstance(raw_authors, str):
                    raw_authors = biocondaRecipesStandardizer.convert_names_to_list(
                        raw_authors
                    )
                ...
                for maintainer in raw_authors:
                    ...
                    github_user = biocondaRecipesStandardizer.extract_github_user(
                        maintainer
                    )
                    if github_user:
                        user = github_user
                        ...
                        authors.append(
                            {"name": maintainer, "type": "Person", "maintainer": True}
                        )
            ...
            if tool["about"].get("authors"):
                ...
                for author in raw_authors:
                    ...
                    if github_user:
                        ...
                        authors.append(
                            {"name": author, "type": "Person", "maintainer": False}
                        )
