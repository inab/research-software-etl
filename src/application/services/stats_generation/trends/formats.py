...
def formats(tools: List[Dict[str, Any]], collection: str, computations):
    ...
    input_formats_summary = formats_stats(
        input_formats_counts, "input_formats", collection
    )
    ...
    output_formats_summary = formats_stats(
        output_formats_counts, "output_formats", collection
    )
