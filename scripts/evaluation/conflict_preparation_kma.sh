...
# File paths
SCRIPT_PATH="src/adapters/cli/integration/prepare_conflicts.py"
GROUPED_ENTRIES_FILE="scripts/data/grouped_entries.json"
DISCONNECTED_ENTRIES_FILE="scripts/data/disconnected_entries.json"
EVALUATION_CASES_CSV="scripts/evaluation/software_disambiguation_evaluation_conflicts_kma.csv"
PROMPT_TYPE="chat"
MESSAGES_FILE="scripts/evaluation/messages_fix_kma.jsonl"
ENV_FILE=".env"
...
python3 "$SCRIPT_PATH" \
    ...
    --prompt-type "$PROMPT_TYPE" 2>&1 | tee -a rs-eval-message-prep-kma.log
