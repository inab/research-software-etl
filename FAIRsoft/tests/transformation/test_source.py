from FAIRsoft.transformation.main import transform_this_source, get_raw_data_db
...
class TestGetRawDataDb:
    ...
    def test_valid_source_label(self, mocker):
        ...
        mocker.patch('FAIRsoft.utils.connect_collection')
        alambique_mock = mocker.MagicMock()
        FAIRsoft.utils.connect_collection.return_value = alambique_mock
    ...
    def test_database_connection_failure(self, mocker):
        ...
        mocker.patch('FAIRsoft.utils.connect_collection', side_effect=Exception('Database connection failed'))
